...
class ArbolBinario(Arbol):
    ...
    def _buscar_recursiva(self, valor: T, nodo_actual: 'NodoInterface') -> Optional['NodoInterface']:
    ...
    def buscarAll(self, valor: T) -> list['NodoInterface']:
        resultados = []
        if self.raiz is not None:
            self._buscarAll_recursiva(valor, self.raiz, resultados)
        return resultados
    
    def _buscarAll_recursiva(self, valor: T, nodo_actual: 'NodoInterface', resultados: list['NodoInterface']) -> None:
    ...
    def buscarWhere(self, proposicion: Callable[['NodoInterface'], bool]) -> list['NodoInterface']:
        resultados = []
        if self.raiz is not None:
            self._buscarWhere_recursiva(proposicion, self.raiz, resultados)
        return resultados
    
    def _buscarWhere_recursiva(self, proposicion: Callable[['NodoInterface'], bool], nodo_actual: 'NodoInterface', resultados: list['NodoInterface']) -> None:
